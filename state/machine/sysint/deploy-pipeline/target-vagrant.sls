...
"031A2C45-08E5-4C1B-A6E4-22499BF05A7E":
  ...
  ssh_auth.present:
    - user: vagrant
    - source: salt://assets/keymat/sshkey_hashicorp-vagrant-pubkey
  file.managed:
...
# remove provision time netdev to avoid later conflicts, (only appropriate where netdev isn't dependent on these files for basic operation)
{%- if salt['grains.get']('os') == "CentOS" and salt['grains.get']('osmajorrelease')|int == 7 %}
